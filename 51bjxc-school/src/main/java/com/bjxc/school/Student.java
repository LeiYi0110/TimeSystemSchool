...
public class Student {
	...
	private String idAddress;//身份证中的地址
	private String emerContaPersMobile;//紧急联系人电话号码
	private Integer consultantId;//咨询员ID
	
	private String areaName;  //片区
	private String receiptNum;//回执编号
	private Date classDate;	//理论课排班上课日期
	private Integer wayForClass;//理论课排班 上课方式  0-需接送 1-自己去 
	 ...
	 * 指纹图片ID
	 */
	private Integer fingerprintsId;
	...
	public Integer getWayForClass() {
		return wayForClass;
	}
	public void setWayForClass(Integer wayForClass) {
		this.wayForClass = wayForClass;
	}
	...
	public String getEmerContaPersMobile() {
		return emerContaPersMobile;
	}
	public void setEmerContaPersMobile(String emerContaPersMobile) {
		this.emerContaPersMobile = emerContaPersMobile;
	}
	...
	public Integer getFingerprintsId() {
		return fingerprintsId;
	}
	public void setFingerprintsId(Integer fingerprintsId) {
