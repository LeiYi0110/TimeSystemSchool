...
//		header = new Header();
//		header.setVersion(copiedBuffer.readByte());
//		header.setId(copiedBuffer.readShort());
//		header.setProperty(copiedBuffer.readShort());
//		byte[] mobileBytes = new byte[8];
//		copiedBuffer.readBytes(mobileBytes);
//		header.setMobile(HexUtils.bcd2Str(mobileBytes));
//		header.setNumber(copiedBuffer.readShort());
//		header.setBackup(copiedBuffer.readByte());
//		body = new byte[copiedBuffer.readableBytes()-2];
//		copiedBuffer.readBytes(body);
//		check = copiedBuffer.readByte();
//		last = copiedBuffer.readByte();
	...
	public String getMessageString(){
		...
		sbf.append(":message id:" + Integer.toHexString(this.getHeader().getId()));
		sbf.append(";version:" + this.getHeader().getVersion());
		sbf.append(";property:" + Integer.toBinaryString(this.getHeader().getProperty()));
		sbf.append(";encrypt:" + this.getHeader().getEncrypt());
		sbf.append(";length:" + this.getHeader().getLength());
		sbf.append(";subpackage:" + this.getHeader().isSubPackage());
		sbf.append(";packageSize:" + this.getHeader().getPackageSize());
		sbf.append(";packageIndex:" + this.getHeader().getPackageIndex());
		sbf.append(";mobile:" + this.getHeader().getMobile());
		try {
			sbf.append("body:" + this.getBodyToString());
