...
<body>
	<div style="padding: 24px">
		<form class="form-horizontal" action="${ctx}/TCPClient/login" method="post" id="formId">
		  ...
		  <div class="control-group">
		    <label class="control-label">平台接入码:</label>
		    <div class="controls">
		      <input type="text" name="code" placeholder="DWORD" value="12345678"/>
		    </div>
		  </div>
		  <div class="control-group">
