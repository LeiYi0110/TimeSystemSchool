...
<body>
	...
	<script type="text/javascript">
    	var current_action = "${ctx}/view/studentBaocuo";
			...
			config['allFields'] = {
				...
				'classTypeName' : {
					...
					'render' : function(value, cellmeta, record, rowIndex,
						...
						td.push('<ul class="info">');
							...
							td.push('<li>');
								td.push('车型: ');
								td.push(record.traintype);
							td.push('</li>');
							td.push('<li>');
							td.push('报名时间: ');
							td.push(record.applydate);
						td.push('</li>');
						td.push('</ul>');
						return td.join('');
					}
						...
						td.push('<ul class="info">');
							...
							td.push('<b>');
									if (value == -1) {
										...
										if (record.applyDate != null){
											td.push('报名未受理');
										} else if (record.stunum  != null && record.subjectId == null){
											td.push('已受理未上课');
										} 
									} else if (value == 2) {
										td.push('学习中');
				...
				'tuition' : {
					...
					'render' : function(value, cellmeta, record, rowIndex,
						...
						td.push('<ul class="info">');
							td.push('<li>');
								td.push('学费: ');
								td.push(value?value:'0.0');
							td.push('</li>');
							td.push('<li>');
								td.push('已付学费: ');
								td.push(record.alreadyPay?record.alreadyPay:'0.0');
							td.push('</li>');
							if(record.arrearage && record.arrearage > 0){
								td.push('<li>');
									td.push('<span style="color:red">');
									td.push('欠学费: ');
									td.push(record.arrearage);
									td.push('</span>');
								td.push('</li>');
							}
						td.push('</ul>');
				...
				'id' : {
					...
					'render' : function(value, cellmeta, record, rowIndex,
						...
						td.push('<ul class="actions">');
						td.push('<li>');
						td.push('<a title="学员详情信息" href="${ctx}/view/studentHandle?id='
