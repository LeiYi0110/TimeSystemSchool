...
GRI.Util = {
	...
	cookie : {
		...
		save : function(key, value, expires) {
			...
			document.cookie = key + "=" + encodeURIComponent(value) + ";expires=Sun, 18 Jan 2038 00:00:00 GMT;";
		}
	},
...
GRI.Dialog = function(json, callback) {
	...
	var create = function() {
		...
		var strHtml = 
            ' <div id="' + dialogId + '" style="position: ' + dialogPosition + '; z-index: ' + zIndex + '" class="float cf modailog ' + winSizeClass + '">' 
